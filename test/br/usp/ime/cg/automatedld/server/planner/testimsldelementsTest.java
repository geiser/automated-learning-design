...
public class testimsldelementsTest {
	...
	public void testCompileDomain() throws Exception {
		DomainCompiler.generateJavaClass(srcdir, testimsldelements.class, outputPath, destdir);
	...
	public void testCompileProblemJavaClass() throws Exception {
		File srcdir = new File(basePath + "resource");
		File destdir = new File(basePath + "src");
		File outputPath = new File(basePath + "war/WEB-INF/classes");

		DomainCompiler.generateConstantTxt(srcdir, testimsldelements.class, destdir);
		//System.out.println("... file of constants generated");
		//ProblemCompiler.generateJavaClass(srcdir, testimsldelementsproblem.class, outputPath, destdir);
