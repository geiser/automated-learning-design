...
<body>
	<br/>
    <h1>Concepts (<a href="<c:url value="/metadatas/concepts/add" />" >Add</a> )</h1>
    <table align="center">
      <tr>
        <td id="conceptContainer">
        
        <script type="text/javascript" language="javascript" >
 			var fields = new Array("identifier","properties/property[@name='title']/value");
            var titles = new Array("URL","Title");
            injectorsHolder['conceptContainer'] = function() {
                addMetadataListView('conceptContainer', 'concept', fields, titles, '<c:url value="/" />');
            };
 		</script>
	    ...
	    <div style="width: 22em; position: absolute; left: 50%; margin-left: -11em; color: red; background-color: white; border: 1px solid red; padding: 4px; font-family: sans-serif">
	        ...
	        <div>
	            <ul>
	                <li>Identifier - Title - Options ( <a href="<c:url value="/metadatas/concepts/add" />" >Add</a> )</li>
	                ...
	                <li><c:out value="${metadata.identifier}" /> -
	                    ...
	                    <a href="<c:url value="/metadatas/concepts/${metadata.id}" />" >Edit / Delete</a></li>
	                </c:forEach>
	            </ul>
	        </div>
	   </div>
