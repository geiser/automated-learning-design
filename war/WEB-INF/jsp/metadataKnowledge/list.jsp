...
<body>
	<br/>
    <h1>Knowledges (<a href="<c:url value="/metadatas/knowledges/add" />" >Add</a> )</h1>
    <table align="center">
      <tr>
        <td id="knowledgeContainer">
        
        <script type="text/javascript" language="javascript" >
        	var fields = new Array("identifier","properties/property[@name='title']/value");
        	var titles = new Array("URL","Title");
 			injectorsHolder['knowledgeContainer'] = function() {
 				addMetadataListView('knowledgeContainer', 'knowledge', fields, titles, '<c:url value="/" />');
 			};
 		</script>
	    
	    <!-- if  web app will not function without JavaScript enabled -->
	    <noscript>
	    <div style="width: 22em; position: absolute; left: 50%; margin-left: -11em; color: red; background-color: white; border: 1px solid red; padding: 4px; font-family: sans-serif">
	        ...
	        <div>
	        <ul>
	            <li>Identifier - Title - Options ( <a href="<c:url value="/metadatas/knowledges/add" />" >Add</a> )</li>
	            ...
	            <li><c:out value="${metadata.identifier}" /> -
	                ...
	                <a href="<c:url value="/metadatas/knowledges/${metadata.id}" />" >Edit / Delete</a></li>
	            </c:forEach>
	        </ul>
	        </div>
	    </div>
